...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('public/img/westminster/logo.jpg') }}" class="rounded-circle" rel="icon">
    ...
    <div class="container-fluid bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                <img src="{{ asset('public/img/westminster/logo.jpg') }}" alt="WestminsterPh Logo" class="logo-img rounded-circle" style="width: 40px;">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ url('job-list') }}" class="nav-item nav-link">Job List</a>
                    <a href="{{ url('#') }}" class="nav-item nav-link">Team</a>
                    <a href="{{ url('contact') }}" class="nav-item nav-link">Contact</a>
                </div>
                <a href="{{ url('#') }}" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block"><i class="fa fa-phone-alt me-3"></i> +632 8689 6796</a>
            </div>
        </nav>
        <!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5">                    
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link text-white-50" href="{{ url('news') }}">News</a>
                        <a class="btn btn-link text-white-50" href="{{ url('job-list') }}">Job List</a>
