            ...
            <div class="container py-5">
                <div class="row g-5">                    
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link text-white-50" href="<?php echo e(url('about')); ?>">About Us</a>
                        <a class="btn btn-link text-white-50" href="<?php echo e(url('news')); ?>">News</a>
                        <a class="btn btn-link text-white-50" href="<?php echo e(url('job-list')); ?>">Job List</a>
                        <a class="btn btn-link text-white-50" href="">Team</a>
                        <a class="btn btn-link text-white-50" href="<?php echo e(url('contact')); ?>">Contact</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
...
</html><?php /**PATH C:\webproject\htdocs\westminsterph\resources\views/layout/layout.blade.php ENDPATH**/ ?>