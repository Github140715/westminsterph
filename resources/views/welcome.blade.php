...
<div class="container-fluid p-0">
    <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{ asset('public/img/westminster/carousel-1.jpeg') }}" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            ...
                            <a href="{{ url('job-list') }}" class="btn btn-secondary py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</a>
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{ asset('public/img/westminster/carousel-2.jpeg') }}" alt="">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-0 about-bg rounded overflow-hidden">
                    <div class="col-6 text-start">
                        <img class="img-fluid w-100" src="{{ asset('public/img/westminster/about-1.jpeg') }}">
                    </div>
                    <div class="col-6 text-start">
                        <img class="img-fluid" src="{{ asset('public/img/westminster/about-3.jpeg') }}" style="width: 85%; margin-top: 15%;">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid" src="{{ asset('public/img/westminster/about-4.jpeg') }}" style="width: 85%;">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid w-100" src="{{ asset('public/img/westminster/about-2.jpeg') }}">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <a class="btn btn-primary py-3 px-5 mt-3" href="{{ url('about') }}">About Us</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <a class="btn btn-primary py-3 px-5" href="{{ url('job-list') }}">Browse More Jobs</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4 ">
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp d-flex" data-wow-delay="0.5s">
                <div class="card cat-item flex-fill rounded-3">
                    <img src="{{ asset('public/img/westminster/carousel-1.jpeg') }}" class="card-img-top rounded-top" alt="News Image">
                    <div class="card-body border-top border-primary border-3">
                        <ul class="list-inline">
                            <!-- List Item for Font Awesome Icon -->
                            <li class="list-inline-item text-primary"><i class="fas fa-calendar-alt"></i></li>
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp d-flex" data-wow-delay="0.5s">
                <div class="card cat-item flex-fill rounded-3">
                    <img src="{{ asset('public/img/westminster/carousel-2.jpeg') }}" class="card-img-top rounded-top" alt="News Image">
                    <div class="card-body border-top border-primary border-3">
                        <ul class="list-inline">
                            <!-- List Item for Font Awesome Icon -->
                            <li class="list-inline-item text-primary"><i class="fas fa-calendar-alt"></i></li>
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp d-flex" data-wow-delay="0.5s">
                <div class="card cat-item flex-fill rounded-3">
                    <img src="{{ asset('public/img/westminster/carousel-4.jpeg') }}" class="card-img-top rounded-top" alt="News Image">
                    <div class="card-body border-top border-primary border-3">
                        <ul class="list-inline">
                            <!-- List Item for Font Awesome Icon -->
                            <li class="list-inline-item text-primary"><i class="fas fa-calendar-alt"></i></li>
            ...
            <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.5s">
                <a class="btn btn-primary py-3 px-5" href="{{ url('news') }}">Browse More News</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="owl-carousel testimonial-carousel">
            <div class="testimonial-item bg-light rounded p-4">
                ...
                <div class="d-flex align-items-center">
                    <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('public/img/westminster/testimonial-1.jpeg') }}" style="width: 50px; height: 50px;">
                    <div class="ps-3">
            ...
            <div class="testimonial-item bg-light rounded p-4">
                ...
                <div class="d-flex align-items-center">
                    <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('public/img/westminster/testimonial-2.jpeg') }}" style="width: 50px; height: 50px;">
                    <div class="ps-3">
            ...
            <div class="testimonial-item bg-light rounded p-4">
                ...
                <div class="d-flex align-items-center">
                    <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('public/img/westminster/testimonial-3.jpeg') }}" style="width: 50px; height: 50px;">
                    <div class="ps-3">
            ...
            <div class="testimonial-item bg-light rounded p-4">
                ...
                <div class="d-flex align-items-center">
                    <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('public/img/westminster/testimonial-4.jpeg') }}" style="width: 50px; height: 50px;">
                    <div class="ps-3">
