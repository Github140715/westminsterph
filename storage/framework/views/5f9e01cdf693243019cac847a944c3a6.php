...
<?php $__env->startSection('page-title'); ?>Job List <?php $__env->stopSection(); ?>
        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <a class="btn btn-primary py-3 px-5" href="<?php echo e(url('job-list')); ?>">Load More Jobs</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Programs\XAMPP\htdocs\westminsterph\resources\views/job-list.blade.php ENDPATH**/ ?>